    ...
    def clone(self, link):
        ...
        try:
            ...
            if meta.get("mimeType") == self.__G_DRIVE_DIR_MIME_TYPE:
                ...
                msg += f'<b>⌈➳ 💌 ҒᏆᏞᎬ-ΝᎪᎷᎬ : </b><code>{meta.get("name")}</code>\n\n<b>⌈➳ 💎 ᎪᏴϴႮͲ ՏᏆᏃᎬ : </b><code>{get_readable_file_size(self.transferred_size)}</code>\n'
                msg += '\n<b>⌈➳ 📇 ᎢᎩᑭᗴ :</b><code> ⌈➳ 👰 ꞞƎᗭꞀOℲ </code>'
                msg += f'\n<b>⌈➳ 🗂 ՏႮᏴ-ҒϴᏞᎠᎬᎡՏ : </b><code>{self.total_folders}</code>'
                msg += f'\n<b>⌈➳ 👸 ғɪʟᴇs : </b><code>{self.total_files}</code>\n<b>=> ᴅᴏɴ༝ᴛ sʜᴀʀᴇ ᴛʜᴇ ɪɴᴅᴇx ʟɪɴᴋ ᴏᴜᴛsɪᴅᴇ ᴛʜɪs ɢʀᴏᴜᴘ..! 😎</b>\n<b>⌈➳ 🧰 мαℓωαяєѕ : ղօ ✅</b>'
                buttons = button_build.ButtonMaker()
                if SHORTENER is not None and SHORTENER_API is not None:
                    surl = short_url(durl)
                    buttons.buildbutton("🌩 ᎠᎡᏆᏙᎬ-ᏞᏆΝᏦ 🌩", surl)
                else:
                    buttons.buildbutton("🌩 ᎠᎡᏆᏙᎬ-ᏞᏆΝᏦ 🌩", durl)
                if INDEX_URL is not None:
                    url_path = requests.utils.quote(f'{meta.get("name")}')
                    url = f'{INDEX_URL}/{url_path}/'
                    if SHORTENER is not None and SHORTENER_API is not None:
                        siurl = short_url(url)
                        buttons.buildbutton("🔰 ᏆΝᎠᎬХ-ᏞᏆΝᏦ 🔰", siurl)
                    else:
                        buttons.buildbutton("🔰 ᏆΝᎠᎬХ-ᏞᏆΝᏦ 🔰", url)
            else:
                ...
                if SHORTENER is not None and SHORTENER_API is not None:
                    surl = short_url(durl)
                    buttons.buildbutton("🌩 ꞰNIꞀ-ƎΛIꞞᗭ 🌩", surl)
                else:
                    buttons.buildbutton("🌩 ꞰNIꞀ-ƎΛIꞞᗭ 🌩", durl)
                try:
                    typ = file.get('mimeType')
                except:
                    typ = 'File'
                try:
                    msg += f'\n<b>⌈➳ 🛅 sɪᴢᴇ-ɪɴғᴏ : </b><code>{get_readable_file_size(int(meta.get("size")))}</code>'
                    msg += f'\n<b>⌈➳ 💎 ԵՎρe : </b><code>{typ}</code>\n<b>=> ᴅᴏɴ༝ᴛ sʜᴀʀᴇ ᴛʜᴇ ɪɴᴅᴇx ʟɪɴᴋ ᴏᴜᴛsɪᴅᴇ ᴛʜɪs ɢʀᴏᴜᴘ..! 😎</b>'
                except TypeError:
                    pass
                if INDEX_URL is not None:
    ...
    def count(self, link):
        ...
        try:
            ...
            if drive_file['mimeType'] == self.__G_DRIVE_DIR_MIME_TYPE:
                ...
                msg += f'<b>⌈➳ 💌 ҒᏆᏞᎬ-ΝᎪᎷᎬ : </b><code>{name}</code>'
                msg += f'\n<b>⚙ ՏᏆᏃᎬ-ᏆΝҒϴ : </b><code>{get_readable_file_size(self.total_bytes)}</code>'
                msg += '\n<b>⌈➳ 🛅 ԵՎρe : </b><code>⌈➳ ҒϴᏞᎠᎬᎡ 🔰 </code>'
                msg += f'\n<b>⌈➳ 👰 ՏႮᏴ-ҒϴᏞᎠᎬᎡՏ : </b><code>{self.total_folders}</code>'
                msg += f'\n<b>⌈➳ 📇 ғɪʟᴇs : </b><code>{self.total_files}</code>'
            else:
