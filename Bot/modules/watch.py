...
def _watch(bot: Bot, update, isTar=False, isZip=False, isLeech=False):
    ...
    try:
        ...
        msg += f"\n\n=> 😎 Example:\n<code>/{BotCommands.WatchCommand} https://youtu.be/un00kN_i 1080 |name</code>\n\n"
        msg += "This file will be downloaded in 1080p quality and it's name will be <b>name.1080p.mp4</b>"
