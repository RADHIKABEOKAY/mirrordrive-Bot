...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="https://telegra.ph/file/b02788a8c2c7ca546d369.jpg" type="image/jpg">
    <script
...
<body>
  <!--© Designed and coded by @bipuldey19-Telegram-->
    <header>
      <div class="brand">
        <img
          src="https://telegra.ph/file/b02788a8c2c7ca546d369.jpg"
          alt="logo"
        />
        <a href="https://t.me/MirrorDrive"> 
          <h2 class="name">MIRRORDRIVE</h2>
        </a>
      </div>
      <div class="social">
        <a href="https://t.me/MirrorDrive"><i class="fab fa-github"></i></a>
        <a href="https://t.me/MirrorDrive"><i class="fab fa-telegram"></i></a>
      </div>
    </header>
    <section>
...
async def homepage(request):
    ...
    return web.Response(text="<h1>See MIRRORDRIVE <a href='https://t.me/MirrorDrive'>@MIRRORDRIVE</a> By <a href='https://t.me/MirrorDrive'>MIRRORDRIVE</a></h1>", content_type="text/html")
